...
export function isBuildGzip(): boolean {
    return process.env.VUE_APP_BUILD_GZIP === 'true'
}
 ...
 * @param confFiles ext
 */
export function getEnvConfig(match = 'VUE_APP_GLOB_', confFiles = ['.env', '.env.production']) {
    let envConfig = {}
